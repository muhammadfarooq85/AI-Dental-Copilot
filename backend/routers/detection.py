...
@router.post("/analyze-base64", response_model=DetectionResponse)
async def analyze_base64_image(request: DetectionRequest):
    """Analyze a base64 encoded image for oral cancer detection"""
    try:
        # Decode base64 image
...
#     return {
#         "model_name": "Oral Cancer Detection Model",
#         "version": "1.0.0",
